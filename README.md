...
const ashish = {
    ...
    goal: "Land a Full Stack Developer Internship",
    codeStyle: "Clean, commented, and production-ready",
    mindset: "Learn → Build → Deploy → Repeat 🔁"
};
```

🎯 **Currently Working On:**
- Building hands-on JavaScript DOM projects
- Learning React ecosystem & component architecture  
- Preparing for full-stack development internships

📫 **Reach Me:** primesetup01@gmail.com
...
**🎯 Actively seeking Full Stack Developer Internships**

| What I Bring | What I'm Learning |
|:---:|:---:|
| ✅ Strong JavaScript fundamentals | 🔄 React & Component Design |
| ✅ DOM manipulation expertise | 🔄 Backend with Node.js & Express |
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6&height=200&section=footer" width="100%"/>
